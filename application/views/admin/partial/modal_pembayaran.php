    ...
    <div class="modal__content">
        ...
        <div class="mt-1">
            ...
            <div class="form-row modal-footer">
                ...
                <div class="col">
                    <div class="form-group tb-point ml-auto">
						...
						?>
                        <input type="text" class="form-control" readonly value="<?= $d['harga_air']; ?>" id="harga"
                            name="harga">
                        <?php endforeach; ?>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group tb-point ml-auto">
						...
						foreach ($menu_we as $d) :
						?>
                        <input type="number" class="form-control" readonly value="<?= $d['beban']; ?>" id="bebanya"
                            name="bebanya">
                        <?php endforeach; ?>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group tb-point ml-auto">
						...
						foreach ($menu_we as $d) :
						?>
                        <input type="number" class="form-control" readonly value="<?= $d['pma']; ?>" id="pma"
                            name="pma">
                        <?php endforeach; ?>
                    </div>
                </div>
            ...
            <div class="d-flex modal-footer">
                <h5>(*)Di isi oleh petugas.</h5>
                <h5> | </h5>
                <h5>(**)Di isi petugas hanya untuk pembayaran pertama kali.</h5>
                <div class="ml-auto">
                    <button type="submit" class="btn btn-info">Simpan</button>
                    <a href="#" class="btn btn-warning" id="batal" onClick="closeDialog()">Batal</a>
                </div>
            </div>
