<main class="app-content">
    ...
    <form action="<?php echo base_url('admin/pembayaran'); ?>" method="POST">
        <div class="row mb-2">
            ...
            <div class="col-md-7">
                <div class="input-group mb-3">
                    <input type="text" id="form_search" name="form_search" class="form-control penci"
                        placeholder="Masukan nomor pelanggan" aria-label="Masukan nomor pelanggan"
                        aria-describedby="button-addon2">
                    <div class="input-group-append">
                        <button class="btn btn-outline-suci" type="submit" id="button-addon2">Proses</button>
                    </div>
                </div>
    ...
    <div class="col-md-3">
        <a href="#bayar-modal" class="btn btn-suci" onClick="showDialog()" id="dialog"><i class="fa fa-plus"></i>Data
            Pemakaian
            Pengguna</a>
    </div>
    </div>
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a <?= $a['bayar'] == $a['total_tagihan'] | $a['bayar'] >= $a['total_tagihan'] ? 'class="btn btn-light ml-auto disabled"' : 'class="btn btn-light ml-auto"' ?>
                                        href="#acc-bayar-modal<?= $a['id_pembayaran']; ?>" onClick="showDialog()"
                                        id="dialog"><i class="fa-solid fa-money-check-dollar"
                                    ...
                                    <a href="#modal-del_pembayaran<?= $a['id_pembayaran']; ?>"
                                        class="btn btn-light ml-auto" type="button" onClick="showDialog()"
